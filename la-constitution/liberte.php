...
<div class="container">
	     <div class="starter-template">
          ...
          <p>La souveraineté se définit, en droit, comme la détention de l’<a href="javascript:;" onclick="">autorité suprême</a>, c’est-à-dire d’un pouvoir absolu (<U>dont tous dépendent</U>) et inconditionné (qui ne dépend de qui que ce soit). Dans les régimes
              <a href="javascript:;"> despotiques</a>, la souveraineté est le plus souvent détenue par <a href="javascript:;" onclick="">un seul</a> homme. Dans les démocraties, elle est détenue <a href="javascript:;" onclick="">par le peuple</a>, constitué en un corps politique, la Nation : on parle dès lors de <a href="javascript:;" onclick="">souveraineté nationale</a>. Dans ce cadre, la souveraineté ne peut être exercée par un <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink1').submit();">despote</a>, ni divisée entre plusieurs fractions du <a href="javascript:;">peuple</a> elle est détenue par un être <U>collectif et indivisible</U>, distinct des individus qui la composent. Mais les contraintes de l’<a href="javascript:;">exercice</a> du pouvoir impliquent que cette souveraineté soit déléguée : le peuple, bien que <a href="javascript:;">constitué</a> en <U>corps politique</U>, ne peut en effet délibérer directement sur les affaires <a href="javascript:;">publiques</a>. Cette mission est donc confiée à des représentants élus, dont les décisions constituent l’expression de la volonté générale.</p>
