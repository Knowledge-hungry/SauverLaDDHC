...
<div class="container">
	     <div class="starter-template">
          ...
          <p>La foi, aux yeux de la Déclaration, <a href="">relève de la vie privée</a>, celle-là même que garantit l'article 2. Aux yeux du droit, la religion s'assimile à un hobby, comme la pêche à la ligne ou les collections de timbres. On peut croire, et
              <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink0').submit();">  même pratiquer</a>
              avec ferveur, à condition de ne pas troubler l'ordre public : un <a href="">préfet</a> peut ainsi autoriser une procession, par exemple, exactement de la même manière qu'il autoriserait une <a href="">manifestation</a> de la CGT.
            </p>
          ...
          <p>La liberté de la presse, si précieuse pour la transmission des opinions et la vivacité du débat politique, de même que la liberté d'expression, si souvent brandie à mauvais escient, connaissent en <a href="">République</a> des bornes précises (autre différence d'avec la démocratie, où n'importe quel âne peut revendiquer le droit de braire plus fort que son voisin). En France, <a href="">l'apologie</a> de crimes de guerre ou de crimes contre l'humanité (article 24 de la loi sur la liberté de la presse), la provocation à la rebellion ou la provocation au
              <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink1').submit();"> suicide </a>
              constituent des délits réprimés par la loi. On <a href="">commence</a> par écarter du débat politique les <a href="">fous sanguinaires</a>, les fanatiques de toutes confessions et <U>les enragés</U> qui se croient très "purs" sous prétexte qu'ils "ne transigeront pas", puis on peut délibérer entre personnes pondérées et responsables. Censure ? Sans doute ; mais du moins pose-t-elle une limite inférieure au <a href="">débat politique</a>, lequel ne peut pas, en principe, déraper vers le niveau du "Jerry Springer Show".
            </p>
