...
L'article se complète par une <a href="">disposition</a> capitale connue sous le nom de "principe de liberté". Quand la Loi ne dit rien, alors c'est permis. Ce qui n'est pas expressément interdit est autorisé. La relaxe des <a href="">pirates informatiques</a> au début des années 90 se fondait sur cet article. Le "principe de liberté" n'est toutefois applicable qu'aux individus. Pour l'<a href="">administration</a>, la situation est rigoureusement contraire - elle est connue sous le nom de "principe d'autorité". Pour une administration, tout ce qui n'est pas expressément autorisé est interdit. Sur le rôle d'impôt sur le revenu, le <a href="">fisc</a> mentionne les articles du Code général des impôts l'autorisant à exercer cet acte.
              <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink0').submit();"> De même </a>
              lorsqu'un agent de police interpelle un quidam, il doit en principe lui signifier la cause de l'arrestation et l'article de loi l'y autorisant. Principe de liberté et principe d'autorité se combinent ainsi pour donner une solution chaque fois que la loi ne prévoit "rien". Contrairement à ce que prétendent nombre de journalistes ignorants, il n'existe aucun "vide juridique" en France : quand la loi "ne dit rien", elle habilite les <a href="">particuliers</a> et empêche l'administration.
            </p>
          ...
          <p>Article fondamental qui exprime le "principe de légalité". Seule la loi peut <a href="">décider</a> si, quand, comment et pour quel motif les agents de l'Etat peuvent exercer la violence contre des citoyens. La loi est d'application stricte : si elle existe, elle possède sa pleine vigueur et l'enfreindre revient à commettre le délit de rébellion (article 433-6 du Code Pénal). En revanche, un <a href="">ordre contraire</a> à la Loi, ou même simplement non-conforme, c'est-à-dire privé de base légale, viole le "principe d'autorité" et un agent de l'Etat qui exécute un tel ordre se rend coupable d'une atteinte aux libertés individuelles (article 432-4 du Code pénal). L'excuse <a href="">présentée</a> par les nazis à Nuremberg ("Je n'ai fait qu'exécuter les ordres") est irrecevable selon l'article 7 : même
              <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink1').submit();"> un soldat </a>
              en service doit refuser d'exécuter un ordre exprès si cet ordre est contraire à la loi. Combinons cela avec l'article 5 : un agent de l'Etat qui exerce une violence physique contre une action qui n'est pas nuisible à la société agit de manière illégale. Peut-il, alors, <a href="">accepter</a> de partir au combat en Irak ? Peut-il expulser des "squatters" ? Peut-il procéder à une vérification d'identité ? Ces questions méritent d'être posées.
            </p>
          ...
          <p>La loi pénale n'est pas rétroactive. Si le piratage informatique n'est incriminé qu'à compter du 1er janvier 1994, un copiage illégal de données accompli le 31 décembre 1993 à 23h59 n'est pas <a href="">répréhensible</a>. Par ailleurs, la loi ne peut établir que des peines "strictement et évidemment nécessaires". La
             <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink2').submit();"> cruauté </a>
             gratuite est exclue du droit pénal, mais également la cruauté "justifiable" qui ne serait pas strictement nécessaire. On peut assurément plaider pour la <a href="">torture</a> ou la peine de mort : ces violences sont-elles pour autant <a href="">absolument</a> indispensables ? Sinon, si d'autres méthodes permettent de parvenir à un même résultat, ces violences ne sont pas légales et un agent de l'Etat qui les commettrait devrait être puni, conformément à l'article 7.
          </p>
          ...
          <p>Ne nous leurrons pas. Les citoyens ont peut-être, dans une rationnalité stricte, toujours "intérêt" à respecter les droits de l'Homme et la liberté d'autrui ; mais de facto ils cèdent parfois à <a href="">leurs passions</a>, à leurs haines, à leur soif de vengeance ou à leurs avidités. Pour contenir ces inclinations violentes, l'Etat doit <a href="">disposer d'une force</a>, d'une violence légale, destinée à préserver l'ordre public et l'intérêt commun. L'armée et la police se révèlent indispensables ; mais elles ne
             <a href="javascript:;" onclick="ShowMessage();document.getElementById('FormWithALink3').submit();"> peuvent </a>
             jamais devenir des milices, bras armé d'un gang de bandits qui serait parvenu à s'emparer du pouvoir. Les ordres de tels individus, arbitraires par nature, seraient toujours <a href="">illégaux</a> ; et en vertu de l'article 7, les agents de l'Etat se rendraient coupables par l'exécution de tels ordres. Ils auraient le devoir d'y résister.
          </p>
